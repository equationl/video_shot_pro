...
public class PlayerForData2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_for_data2);
        init();
        checkUri();
        initVideoPlayer();
        adaptationDo();
    ...
    private void initVideoPlayer() {
        ...
        videoPlayer.getFullscreenButton().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //videoPlayer.startWindowFullscreen(Player2Activity.this, false, false);
            }
        });
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<PlayerForData2Activity> mActivity;

        public MyHandler(PlayerForData2Activity activity) {
            mActivity = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            PlayerForData2Activity activity = mActivity.get();
            if (activity != null) {
                switch (msg.what) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if ((keyCode == KeyEvent.KEYCODE_BACK)) {
            if (Do.equals("FrameByFrame")) {
                ...
                Intent intent = new Intent(PlayerForData2Activity.this, MainActivity.class);
